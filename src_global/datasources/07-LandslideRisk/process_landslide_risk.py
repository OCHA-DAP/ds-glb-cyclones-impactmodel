...
if __name__ == "__main__":
    ...
    grid_global = gpd.read_file("/data/big/fmoss/data/GRID/merged/global_grid_land_overlap.gpkg")
    ...
    # Save it
    out_file_path = "/data/big/fmoss/data/LandSlides/global_grid_landslide_risk.csv"
